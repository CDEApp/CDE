...
namespace cdeLib
{
    ...
    // /// </summary>
    // public delegate bool TraverseFunc(ICommonEntry ce, DirEntry de);

    // [ProtoContract
    //  ,ProtoInclude(1, typeof(RootEntry))
    //  ,ProtoInclude(2, typeof(DirEntry))]
    // [FlatBufferTable]
    // public class CommonEntry : object, ICommonEntry
    // {
    ...
    //     [FlatBufferItem(3)]
    //     public virtual List<DirEntry> Children { get; set; }
